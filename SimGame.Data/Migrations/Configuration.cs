...
namespace SimGame.Data.Migrations
{
    internal sealed class Configuration : DbMigrationsConfiguration<GameSimContext>
    {
        ...
        private static ManufacturerType _tokyoImportManufacturerType;
        private static ManufacturerType _parisImportManufacturerType;
...
//            context.Manufacturers.AddOrUpdate(x => x.Id, CreateManufacturer(totalNumberOfProducts, "City Storage", GetManufacturerQueueSlots(totalNumberOfProducts), _donutShopManufacturerType, true));
        ...
        private static void InitializeManufacturerTypes(IGameSimContext context)
        {
            ...
            _tokyoImportManufacturerType = new ManufacturerType
            {
                Id = (int)ManufacturerTypeEnum.TokyoImport,
                Name = "Tokyo Import",
                HasFixedQueueSize = false,
                QueueSize = 1,
                SupportsParallelManufacturing = false
            };
            _parisImportManufacturerType = new ManufacturerType
            {
                Id = (int)ManufacturerTypeEnum.ParisImport,
                Name = "Paris Import",
                HasFixedQueueSize = false,
                QueueSize = 1,
                SupportsParallelManufacturing = false
            };
            _parisImportManufacturerType.ProductTypes = GetParisImportProductTypes();
            _factoryManufacturerType.ProductTypes = GetFactoryProductTypes();
            _tokyoImportManufacturerType.ProductTypes = GetTokyoProductTypes();
            ...
            context.ManufacturerTypes.AddOrUpdate(x => x.Id,
                ...
                _tokyoImportManufacturerType,
                _parisImportManufacturerType
             );
        ...
        private static ICollection<ProductType> GetParisImportProductTypes()
        {
            return new Collection<ProductType>
            {
                new ProductType
                {
                    ManufacturerTypeId = (int)ManufacturerTypeEnum.ParisImport,
                    Id = (int)ProductTypeEnum.FashionClothes,
                    Name = "Paris Fashion Clothes",
                    TimeToManufacture = 360
                },
                new ProductType
                {
                    ManufacturerTypeId = (int)ManufacturerTypeEnum.ParisImport,
                    Id = (int)ProductTypeEnum.LuxuryBag,
                    Name = "Luxury Bag",
                    TimeToManufacture = 360
                },
                new ProductType
                {
                    ManufacturerTypeId = (int)ManufacturerTypeEnum.ParisImport,
                    Id = (int)ProductTypeEnum.LaBaguette,
                    Name = "La Baguette",
                    TimeToManufacture = 360
                }
            };
        ...
        private static Collection<ProductType> GetTokyoProductTypes()
        {            
            return new Collection<ProductType>
            {
                new ProductType
                {
                    ManufacturerTypeId = (int)ManufacturerTypeEnum.TokyoImport,
                    Id = (int)ProductTypeEnum.Lantern,
                    Name = "Lantern",
                    TimeToManufacture = 360
                },
                new ProductType
                {
                    ManufacturerTypeId = (int)ManufacturerTypeEnum.TokyoImport,
                    Id = (int)ProductTypeEnum.BonsaiTree,
                    Name = "Bonsai Tree",
                    TimeToManufacture = 360
                },
                new ProductType
                {
                    ManufacturerTypeId = (int)ManufacturerTypeEnum.TokyoImport,
                    Id = (int)ProductTypeEnum.LuckyCat,
                    Name = "Lucky Cat",
                    TimeToManufacture = 360
                }
            };
